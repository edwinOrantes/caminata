...
<html lang="en" dir="ltr">
   <head>
      ...
      <!-- FAVICON -->
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url(); ?>public/images/brand/favicon.ico" />
      <!-- TITLE -->
         ...
         <div class="container-fluid main-container">
            <div class="d-flex">
               ...
               <a class="logo-horizontal " href="<?= base_url(); ?>">
                  ...
                  <img src="<?php echo base_url(); ?>public/images/brand/logo-3.png" class="header-brand-img light-logo1"alt="logo">
               </a>
               <!-- LOGO -->
                     ...
                     <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                        <div class="d-flex order-lg-2">
                           ...
                           <div class="dropdown d-flex profile-1">
                              ...
                              <img src="<?php echo base_url(); ?>public/images/users/1.jpg" alt="profile-user"
      ...
      <div class="sticky">
         ...
         <div class="app-sidebar">
            <div class="side-header">
               ...
               <img src="<?php echo base_url(); ?>public/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">
               <img src="<?php echo base_url(); ?>public/images/brand/logo-1.png" class="header-brand-img toggle-logo" alt="logo">
               <img src="<?php echo base_url(); ?>public/images/brand/logo-2.png" class="header-brand-img light-logo" alt="logo">
               <img src="<?php echo base_url(); ?>public/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">
               </a>
               <!-- LOGO -->
            </div>
